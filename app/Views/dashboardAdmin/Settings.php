        ...
        <nav class="topbar-nav">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu-profile" id="profileMenu">
                    ...
                    <a href="#" class="dropdown-item-profile"><i class="ti ti-settings"></i> Settings</a>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-section">
                ...
                <a href="#" class="sidebar-item"><i class="ti ti-settings"></i> Settings</a>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($login as $s) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="role-select btn-create"
                                        data-id="<?= $s['id']; ?>">
                                        <option value="admin"
                                ...
                                <td>
                                    ...
                                    <button type="button" class="profile-btn link-update" onclick="editProfile()">
                                    ...
                                    <button
                                        type="button"
                                        class="profile-btn delete-btn mt-1 link-delete"
                                        onclick="hapusAkun(<?= $s['id']; ?>)">
...
<script>
    // ====== PERMISSION CRUD via localStorage ======
    const PERM_KEY = 'crud_permissions';
    ...
    // Saat halaman dibuka, set posisi toggle sesuai data tersimpan
    (function initToggles() {
        ...
        document.querySelectorAll('.perm-toggle').forEach(toggle => {
            ...
            if (perms[user] && perms[user][field]) {
                toggle.checked = true;
            }
        });
    })();

    // Saat toggle diubah, simpan ke localStorage
    document.querySelectorAll('.perm-toggle').forEach(toggle => {
        ...
        toggle.addEventListener('change', function() {
            ...
            perms[user][field] = value;
            savePerms(perms);

            Swal.fire({
                icon: 'success',
                title: 'Permission Updated',
                text: field.toUpperCase() + ' untuk ' + user +
                    (value ? ' diaktifkan' : ' dimatikan'),
                timer: 1300,
...
<script>
    function editProfile() {
        ...
        fetch("<?= site_url('Settings/getUserAdS') ?>")
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch("<?= site_url('Settings/updateProfileAdS') ?>", {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href =
                    "<?= site_url('Settings/deleteAccountS/') ?>" + id;
...
<script>
    document.querySelectorAll('.role-select').forEach(select => {
        ...
        select.addEventListener('change', function() {
            ...
            fetch("<?= site_url('DashboardAdmin/updateRole') ?>", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/x-www-form-urlencoded"
                    },
