        ...
        <main class="main">
            <div class="page-header">
                ...
                <div class="header-actions">
                    ...
                    <a href="<?= site_url('FormKelasAdmin') ?>" class="btn btn-primary btn-create">
                    ...
                    <div class="book-card">
                        <div class="card-menu">
                            ...
                            <div class="menu-dropdown">
                                ...
                                <a href="<?= site_url('FormEditAd/FormKelasEditAd/' . $k['id']) ?>" class="link-update">
                                    <i class="ti ti-edit"></i> Edit
                                </a>

                                <a href="<?= site_url('FormKelasAdmin/delete/' . $k['id']) ?>" class="link-delete"
                        ...
                        <div class="book-body">
                            ...
                            <div style="margin-bottom:8px; display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                                ...
                                <a href="<?= site_url('FormAbsensiAd/FormSiswaAd') ?>" class="absen-btn">
                                    Absen Now
                                </a>
...
<script>
    // ====== Terapkan PERMISSION CRUD dari localStorage ======
    ...
    // Default: kalau user belum diatur, anggap semua mati (tidak punya akses)
    ...
    if (!myPerm.create) {
        document.querySelectorAll('.btn-create').forEach(el => el.style.display = 'none');
    }

    // UPDATE -> tombol Edit
    if (!myPerm.update) {
        document.querySelectorAll('.link-update').forEach(el => el.style.display = 'none');
    }

    // DELETE -> tombol Hapus
    if (!myPerm.delete) {
        document.querySelectorAll('.link-delete').forEach(el => el.style.display = 'none');
    }
</script>
<script>
...
<?php if (session()->getFlashdata('class_success')) : ?>
    ...
    <script>
        Swal.fire({
            ...
            window.location.href = "<?= site_url('AdminHome') ?>";
        });
    </script>
