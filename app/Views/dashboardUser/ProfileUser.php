...
// greeting + banner sesuai jam
$hour = (int) date('H');

if ($hour >= 5 && $hour < 12) {
    $greeting = 'Selamat Pagi';
    $bannerImg = 'https://i.pinimg.com/736x/1b/be/b7/1bbeb7ff31085e43b6f30c31155e5a35.jpg';
} elseif ($hour >= 12 && $hour < 15) {
    $greeting = 'Selamat Siang';
    $bannerImg = 'https://i.pinimg.com/1200x/b6/6f/a1/b66fa113e46ea845a1f1313bc7cb8df3.jpg';
} elseif ($hour >= 15 && $hour < 18) {
    $greeting = 'Selamat Sore';
    $bannerImg = 'https://i.pinimg.com/1200x/95/a7/db/95a7db59279ab5d0de9901a2a13e6f75.jpg';
} else {
    $greeting = 'Selamat Malam';
    $bannerImg = 'https://i.pinimg.com/736x/0e/39/c4/0e39c4ad49ece7b34904675cc9bb1a66.jpg';
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="topbar-nav">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu-profile" id="profileMenu">
                    ...
                    <a href="#" class="dropdown-item-profile"><i class="ti ti-user"></i> Profile</a>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-section">
                ...
                <a href="<?= site_url('DashboardUser/HomeUser') ?>" class="sidebar-item">
            ...
            <div class="sidebar-section">
                ...
                <a href="#" class="sidebar-item"><i class="ti ti-user"></i> Profile</a>
                ...
                <div class="profile-content">
                    ...
                    <div class="profile-left">
                        ...
                        <div>
                            ...
                            <div class="profile-desc role-btn">
                                Selamat datang,
                                <strong><?= esc($username) ?></strong>
                            </div>
                    ...
                    <div class="profile-actions">
                        ...
                        $role = $akun['role'] ?? 'unknown';   // ganti 'role' sesuai nama kolom kamu
                        ?>
                        <div class="col-12 col-md-auto">
                            <button class="profile-btn role-btn w-100">
                                <i class="ti ti-user"></i>
                                <span><?= esc(ucfirst($role)) ?></span>
                            </button>
                        </div>

                        <button type="button" class="profile-btn" onclick="editProfile()">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href =
                    "<?= site_url('ProfileUser/deleteAccount') ?>";
...
<script>
    function editProfile() {
        ...
        fetch("<?= site_url('ProfileUser/getUser') ?>")
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch("<?= site_url('ProfileUser/updateProfile') ?>", {
                                ...
                                body: "username=" +
                                    encodeURIComponent(result.value.username) +
                                    "&email=" +
