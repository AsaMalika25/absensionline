...
<body>
    ...
    <header class="topbar d-flex flex-wrap">
        ...
        <nav class="topbar-nav">
            ...
            <button class="nav-btn"><i class="ti ti-pencil-minus"></i> History</button>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-section">
                ...
                <a href="#" class="sidebar-item"><i class="ti ti-pencil-minus"></i> History</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($siswa as $s) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('History/edit/' . $s['id']) ?>"
                                        class="btn-edit">
                                        <i class="ti ti-edit"></i> Edit
                                    </a>
                                    <a href="<?= site_url('history/delete/' . $s['id']) ?>"
                                        class="btn-delete">
